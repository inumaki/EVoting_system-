...
contract("Election", function (accounts) {
  ...
  it("initializes with two candidates", function () { //these are async functions so we have to handle promises
    return Election.deployed().then(function (instance) { //ew will fetch instance from callback function and from there we will call count.
